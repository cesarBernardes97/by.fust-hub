          ...
          <div className="pl-sections-inner">
            ...
            <div className="pl-sec-grid">
              ...
              <div className="pl-sec-card pl-rv pl-rv-d1">
                <svg viewBox="0 0 80 80"><circle cx="40" cy="40" r="28" fill="rgba(255,255,255,.04)" stroke="rgba(255,255,255,.3)" strokeWidth="1.5"/><circle cx="40" cy="16" r="2" fill="#FF8A1F" opacity=".6"/><circle cx="40" cy="64" r="2" fill="#FF8A1F" opacity=".6"/><circle cx="16" cy="40" r="2" fill="#FF8A1F" opacity=".6"/><circle cx="64" cy="40" r="2" fill="#FF8A1F" opacity=".6"/><circle cx="23" cy="23" r="2" fill="#FF8A1F" opacity=".6"/><circle cx="57" cy="23" r="2" fill="#FF8A1F" opacity=".6"/><circle cx="23" cy="57" r="2" fill="#FF8A1F" opacity=".6"/><circle cx="57" cy="57" r="2" fill="#FF8A1F" opacity=".6"/></svg>
